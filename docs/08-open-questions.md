...
closing out M-20 the **sixteenth**. Three of those four have since closed — the thirteenth and
fourteenth together under **ADR-032**, the fifteenth under **ADR-033** — leaving the
sixteenth alone open. That subtotal is **scoped to
Step-4-onward filings** — **15 closed + 1 open = 16** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **21 closed + 1 open = 22**. Both are stated because the
