...
Step-4-onward filings** — **22 closed + 1 open = 23** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **28 closed + 1 open = 29**. Both are stated because the
