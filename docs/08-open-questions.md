...
**Open: zero.** All **17** filed deviations are ruled and closed. The Phase-5 filing
...
total to 16. The Phase-5 Groq rebinding is the **eleventh** from Step 4 onward: 11 closed + 0
open = 11, and the 6 pre-Step-4 closures bring the total to **17**.
