...
Step-4-onward filings** — **22 closed + 0 open = 22** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **28 closed + 0 open = 28**. Both are stated because the
