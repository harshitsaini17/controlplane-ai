...
Step-4-onward filings** — **23 closed + 0 open = 23** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **29 closed + 0 open = 29**. Both are stated because the
