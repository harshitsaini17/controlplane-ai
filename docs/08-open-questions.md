...
were ruled, and the **nineteenth** — `[D2-tier2-served-graph-is-unbuildable-on-the-ml-extra]` — closed 2026-08-29 under **ADR-035**, leaving the **twentieth** (`[D3-bound-case-window-count-undercovers-the-policy-bound]`) as the one now open. D2 stays worth reading for *how it was found*. It
...
Step-4-onward filings** — **19 closed + 1 open = 20** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **25 closed + 1 open = 26**. Both are stated because the
