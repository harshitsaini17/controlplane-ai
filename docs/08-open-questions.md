...
Step-4-onward filings** — **25 closed + 1 open = 26** — and the 6 pre-Step-4 filings, all
closed, bring the whole table to **31 closed + 1 open = 32**. Both are stated because the
